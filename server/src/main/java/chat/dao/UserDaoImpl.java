...
public class UserDaoImpl implements UserDao {
    ...
    public UserDto findUserByLogin(String login) {
        try (Connection connection = connectionProvider.get()) {
            ...
            log.warn("Error caused while finding user by login", e);
    ...
    public void saveUserData(UserDto userDto) {
        try (Connection connection = connectionProvider.get()) {
            ...
            log.warn("Error caused while saving user data", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public void updateUserData(UserDto userDto) {
        try (Connection connection = connectionProvider.get()) {
            ...
            log.warn("Error caused while updating user data", e);
            throw new RuntimeException(e);
        }
    ...
    public String findUserHashByLogin(String login) {
        try (Connection connection = connectionProvider.get()) {
            ...
            log.warn("Error caused while finding user hash", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public void registerUser(String login, String password) {
        try (Connection connection = connectionProvider.get()) {
            ...
            log.warn("Error caused while registering new user", e);
            throw new RuntimeException(e);
        }
    }
}
